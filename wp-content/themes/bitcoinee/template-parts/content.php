...
<?php
	...
	<figure class="entry-thumbnail col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'row' ); ?>>
	<figure class="entry-thumbnail col-lg-4 col-md-4 col-sm-12 col-xs-12">
	...
	<div class="entry-summary col-lg-8 col-md-8 col-sm-12 col-xs-12">
		<header class="entry-header">
		<?php
		if ( is_singular() ) :
			the_title( '<h1 class="entry-title">', '</h1>' );
