...
function bfastmag_footer() {
    ...
    <div class="col-md-6 col-md-pull-6 poweredby">
        <?php printf(
            ...
            __( ' %4$s %1$s %5$s  %2$s Powered by %3$s', 'IBINEX' ),
             esc_html__('&copy;  ','bfastmag'),
            sprintf('%s <a href="%1s" title="%2s">%3s</a>',esc_html__( '- Designed By', 'IBINEX' ),  esc_url('https://themepacific.com/bfastmag/'),esc_attr__( 'Free bfast News Magazine WordPress Theme', 'IBINEX' ), esc_html__( 'IBINEX', 'bfastmag' ) ),
            sprintf( '<a href="https://wordpress.org/">%s</a>', esc_html__( 'Nelson Papna', 'IBINEX' )),
            get_bloginfo( 'name' ),
            date( 'Y' )
        ); ?>
    </div><!-- End .col-md-6 -->
