...
<article <?php hybridextend_attr( 'post', '', 'archive-block archive-block3 hcolumn-1-3' ); ?>>
	...
	<div class="entry-grid hgrid">
		...
		<?php $img_size = apply_filters( 'maghoot_post_image_archive_block3', 'hoot-medium-thumb' );
		...
		<div class="entry-grid-content">
			...
			<?php maghoot_meta_info_blocks( maghoot_get_mod('archive_post_meta'), 'archive-block3' ); ?>
