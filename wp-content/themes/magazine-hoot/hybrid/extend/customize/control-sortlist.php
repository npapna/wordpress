	...
	public function render_content() {
		...
		switch ( $this->type ) {
			...
			case 'sortlist' :
				...
				?>
				<ul id="hybridextend-control-sortlist-<?php echo esc_attr( $id ) ?>" class="hybridextend-control-sortlist <?php if ( $open ) echo 'default-open'; ?> <?php if ( $sortable ) echo 'sortable'; ?>">
						...
						<li id="hybridextend-control-sortlist-<?php echo esc_attr( $choiceid ) ?>" class="hybridextend-control-sortlistitem <?php echo ( !$hideable || empty( $choicevalues['sortitem_hide'] ) ? '' : 'deactivated' ) ?>" data-choiceid="<?php echo esc_attr( $choiceid ) ?>">
							...
							<?php if ( $display ) : ?>
								<span class="hybridextend-sortlistitem-head">
									...
									<?php if ( $hideable ) : ?>
										<i class="sortlistitem-display fa fa-eye"><span><?php _e( 'Deactivate', 'hybrid-core' ) ?></span></i>
									<?php endif; ?>
