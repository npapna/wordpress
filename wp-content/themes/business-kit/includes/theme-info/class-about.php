	...
	class Business_Kit_About {
		...
		public function load_assets( $hook ) {
			...
			if ( 'appearance_page_' . $this->page_slug === $hook ) {
				...
				wp_enqueue_style( 'business-kit-about', get_template_directory_uri() . '/includes/theme-info/css/about.css', array(), '1.0.0' );
				wp_enqueue_script( 'business-kit-about', get_template_directory_uri() . '/includes/theme-info/js/about.js', array( 'jquery' ), '1.0.0' );
				$js_vars = array(
					'ajaxurl' => esc_url( admin_url( 'admin-ajax.php' ) ),
				);
				wp_localize_script( 'business-kit-about', 'BusinessPointAboutObject', $js_vars );
			}
		}
		...
		public function free_pro() {
		    ...
		    if ( ! empty( $free_pro ) ) {
		        ...
		        if ( ! empty( $free_pro ) && is_array( $free_pro ) ) {
		            ...
		            echo '<td></td>';
		            echo '<td colspan="2"><a href="https://www.preciousthemes.com/downloads/business-kit-pro/" target="_blank" class="button button-primary button-hero">Business Kit Pro</a></td>';
		            echo '</tr>';
