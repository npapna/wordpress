...
jQuery(function($){
  ////////////////////////////////
      ...
      jQuery(document).on('click', 'input.select-img', function( event ){
        ...
        business_kit_file_frame = wp.media.frames.business_kit_file_frame = wp.media({
          button: {
        ...
        business_kit_file_frame.on( 'select', function() {

          var state = business_kit_file_frame.state('rtam-insert-image');
