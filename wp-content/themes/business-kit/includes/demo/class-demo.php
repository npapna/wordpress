...
if ( ! class_exists( 'Business_Kit_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Business_Kit_Demo {

		/**
		 * Singleton instance of Business_Kit_Demo.
		 *
		 * @var Business_Kit_Demo $instance Business_Kit_Demo instance.
		 */
		...
		/**
		 * Main Business_Kit_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Business_Kit_Demo ) ) {
				self::$instance = new Business_Kit_Demo();
