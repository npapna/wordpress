...
if ( ! function_exists( 'business_kit_get_option' ) ) :
	 ...
	 */
	function business_kit_get_option( $key ) {
...
if ( ! function_exists( 'business_kit_get_default_theme_options' ) ) :
	 ...
	 */
	function business_kit_get_default_theme_options() {
		...
		// Footer.
		$defaults['copyright_text'] 	= esc_html__( 'Copyright &copy; All rights reserved.', 'business-kit' );
		...
		$defaults['slider_readmore_text']    		= esc_html__( 'Read More', 'business-kit' );
...
//=============================================================
if ( ! function_exists( 'business_kit_get_options' ) ) :
     ...
     */
    function business_kit_get_options() {
